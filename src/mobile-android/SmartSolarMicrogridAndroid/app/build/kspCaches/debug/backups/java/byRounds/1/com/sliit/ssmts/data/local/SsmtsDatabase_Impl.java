...
import com.sliit.ssmts.data.local.dao.SessionDao_Impl;
...
public final class SsmtsDatabase_Impl extends SsmtsDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(3) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsUserSession.put("nic", new TableInfo.Column("nic", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUserSession.put("username", new TableInfo.Column("username", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUserSession.put("fullName", new TableInfo.Column("fullName", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUserSession.put("phone", new TableInfo.Column("phone", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUserSession.put("address", new TableInfo.Column("address", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUserSession.put("latitude", new TableInfo.Column("latitude", "REAL", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashSet<TableInfo.Index> _indicesUserSession = new HashSet<TableInfo.Index>(0);
        final TableInfo _infoUserSession = new TableInfo("user_session", _columnsUserSession, _foreignKeysUserSession, _indicesUserSession);
        final TableInfo _existingUserSession = TableInfo.read(db, "user_session");
        if (!_infoUserSession.equals(_existingUserSession)) {
          return new RoomOpenHelper.ValidationResult(false, "user_session(com.sliit.ssmts.data.local.entity.SessionEntity).\n"
                  + " Expected:\n" + _infoUserSession + "\n"
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "user_session");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `user_session`");
